...
getProduct().then(product => {
  ...
  useEffect(() => {
    const getRelatedProducts =async  () => {
      return  await (await fetch('/my-site-3/_api/hack-reverse-proxy/api/get-products', {headers: { 'Content-Type': 'application/json'}, method: "POST", body: JSON.stringify({query: {paging: {limit: 4}}, authorization})})).json()
    }
